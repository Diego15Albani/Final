...
<html>
<link rel="icon" href="<?php echo base_url('img/logo2.png');?>" type="image/x-icon">

<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Favicon-->
    <link rel="icon" src="<?php echo base_url('img/logo.png');?>" type="image/x-icon">
...
?>
    <div class="login-box">
        <div class="logo">
        <center>
             <img id="profile-img"  src="<?php echo base_url('img/logo.png');?>" width="200" heigth="60">
             </center>
             <br>
            <small><h4>Sistema de Gestão</h4></small>
        </div>
        <div class="card">
            <div class="body">
